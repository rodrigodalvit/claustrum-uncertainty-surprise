...
%   - Added exact test
% 2018-01-31 lrk
%   - Replaced calls to mean() with nanmean() * I CHANGED TO
%   mean(x,'omitnan')
% 2017-06-15 lrk
...
observeddifference = mean(sample1,'omitnan') - mean(sample2,'omitnan');
...
for n = 1:permutations
    ...
    randomdifferences(n) = mean(randomSample1, 'omitnan') - mean(randomSample2,'omitnan');
end
